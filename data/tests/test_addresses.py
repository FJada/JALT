...
def temp_user():
    ...
    ret = am.add_user(username, '123456', {'address': '123 Main St, New York, NY 10001', 'nearest_train_station': 'Penn Station'}, {'address': '456 Broadway, New York, NY 10002', 'nearest_train_station': 'Grand Central Terminal'})
    yield username
...
def test_add_user_dup_name(temp_user):
    ...
    with pytest.raises(ValueError):
        am.add_user(temp_user, '789012', {'address': '789 Broadway, New York, NY 10003', 'nearest_train_station': 'Times Square'}, {'address': '101 Park Ave, New York, NY 10004', 'nearest_train_station': 'Union Square'})
...
def test_add_user_blank_name():
    ...
    """
    with pytest.raises(ValueError):
        am.add_user('', '789012', {'address': '789 Broadway, New York, NY 10003', 'nearest_train_station': 'Times Square'}, {'address': '101 Park Ave, New York, NY 10004', 'nearest_train_station': 'Union Square'})
...
def test_add_user():
    ...
    ret = am.add_user(new_username, '789012', {'address': '789 Broadway, New York, NY 10003', 'nearest_train_station': 'Times Square'}, {'address': '101 Park Ave, New York, NY 10004', 'nearest_train_station': 'Union Square'})
